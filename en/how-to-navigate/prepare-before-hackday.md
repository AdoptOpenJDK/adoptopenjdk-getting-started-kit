...
These images are also available via portable drives to be copied from. In either case you will need to _Import it as an Appliance via the VirtualBox_main menu.
